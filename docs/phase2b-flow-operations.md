...
| FLOW_RECOVERY_MAX_BLOCKS | 100 | Maximum covered blocks per recovery filter; older gap stays partial |
| FLOW_MAX_WS_BYTES_PER_DAY | 8000000 | Persisted received-message bytes, resets at UTC midnight |
